...
import com.example.stimulate.utils.Constant;
...
public class BaseController {
    ...
    public User getUser() {
        ...
        user.setId((Integer) request.getSession().getAttribute("role_id"));
        return user;
    ...
    public String getUsername() {
        HttpServletRequest request = ((ServletRequestAttributes) RequestContextHolder.getRequestAttributes())
                .getRequest();
        String trueName = request.getSession().getAttribute("true_name") + "";
        return trueName;
    }
